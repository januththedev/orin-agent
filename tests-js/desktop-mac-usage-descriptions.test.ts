 ...
 *
 * Each entry is a key/value pair that lands in the packaged Orin.app's
 ...
 * "Orin wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Orin wants to access Music" when Orin never touches the Music
