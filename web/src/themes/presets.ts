...
/** Orin — cyan accents and amber glow on a warm stone canvas. */
export const orinTheme: DashboardTheme = {
  name: "orin",
  label: "Orin",
  description: "Orin cyan on warm stone with an amber glow",
  palette: {
    background: { hex: "#FAFAF9", alpha: 1 },
    midground: { hex: "#0891B2", alpha: 1 },
    foreground: { hex: "#1C1917", alpha: 0 },
    warmGlow: "rgba(217, 119, 6, 0.14)",
    noiseOpacity: 0,
  },
  typography: DEFAULT_TYPOGRAPHY,
  layout: DEFAULT_LAYOUT,
  terminalBackground: "#0C0A09",
  terminalForeground: "#E7E5E4",
  seriesColors: {
    inputTokenAccent: "#0E7490",
    outputTokenAccent: "#0891b2",
  },
  swatchColors: ["#1C1917", "#0891B2", "#D97706"],
};
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Classic Teal (Large)",
  description: "Classic Teal with bigger fonts and roomier spacing",
