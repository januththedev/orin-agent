...
export const DARK_SEEDS: ThemeSeeds = {
  accent: '#FFBF00',
  // The classic Orin navy surfaces are IDENTITY, not derivation drift —
...
// The classic light-mode Orin look was never hand-authored: for years the
...
//
// Anything we can't decide stays dark — the default Orin palette
// is the dark one.
...
export function fromSkin(
  ...
  //    base seeds for this polarity. The base's IDENTITY FILLS (Orin navy
  ...
  // the derived value already carries the identity seeds (e.g. Orin navy).
  const activeRow =
