...
/**
 * Return the Python snippet used to verify Orin can import far enough to
...
/**
 * Return true iff the Orin runtime import probe exits 0.
 *
 ...
 * its immutable, matching Orin package; it must never fall through to the
