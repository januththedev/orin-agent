 ...
 *
 * The pre-update handoff kills Orin-OWNED venv daemons (the memory plugin's
...
/**
 * True when a process is a Orin-owned venv daemon: its exe lives under
 ...
 * spawns DETACHED — it outlives Orin and holds venv shims mapped).
 */
