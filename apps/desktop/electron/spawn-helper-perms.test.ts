...
test('rewrites an archived node-pty root to the matching unpacked tree exactly once', () => {
  assert.equal(
    writableNodePtyRoot('/Orin.app/Contents/Resources/app.asar/dist/node_modules/node-pty'),
    '/Orin.app/Contents/Resources/app.asar.unpacked/dist/node_modules/node-pty'
  )
  assert.equal(
    writableNodePtyRoot('/Orin.app/Contents/Resources/app.asar.unpacked/dist/node_modules/node-pty'),
    '/Orin.app/Contents/Resources/app.asar.unpacked/dist/node_modules/node-pty'
  )
})

test('uses the unpacked helper when resolution reports an app.asar node-pty root', () => {
  const archivedRoot = '/Orin.app/Contents/Resources/app.asar/dist/node_modules/node-pty'
