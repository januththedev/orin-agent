...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Orin to use.',
  ...
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Orin and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Orin.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Orin. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Orin',
    continue: 'Continue in Orin',
  ...
  boot: {
    ready: 'Orin Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Orin settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Orin backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Orin Desktop…'
    },
    errors: {
      backgroundExited:
        'The service that runs your chats closed unexpectedly. Restart it to keep going — your chats and settings are safe.',
      backgroundExitedDuringStartup: 'Orin stopped right after it started.',
      backendStopped: 'Orin stopped working in the background',
      restartHermes: 'Restart Orin',
      openLogs: 'Open logs',
      desktopBootFailed: "Orin couldn't start",
      gatewayConnectionLost: 'Orin lost its connection',
      ...
      gatewaySignInRequired: 'Your remote Orin signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "Orin Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "Orin' background service stopped right after starting.",
      timedOut: "Orin' background service didn't answer in time.",
      permission: "Orin couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so Orin could not start.',
      portInUse: 'Another program is using the network port Orin needs.',
      installMissing: "Part of Orin' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "Orin couldn't start",
      description:
        "Orin' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Orin backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Orin',
    ...
    errors: {
      ...
      storageFailure: "Orin couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This Orin no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed:
        "Orin' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired:
        'Orin was updated but is still running the old version. Restart it to finish the update.',
      restartHermesFailed: "Couldn't restart Orin"
    },
    actions: {
      restartHermes: 'Restart Orin',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Orin',
    ...
    native: {
      ...
      inputBody: 'Orin is waiting for your response.',
      turnDoneTitle: 'Orin finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Orin defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Orin catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Orin generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Orin picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Orin.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Orin closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Orin is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Orin asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Orin was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Orin was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Orin follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Orin can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Orin. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Orin spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Orin is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Orin, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallHermes: 'Uninstall Orin'
    },
    poolLimits: {
    ...
    about: {
      heading: 'Orin Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Orin runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Orin only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Orin',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Orin checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Minimize windows or close the main window to hide them in the system tray (menu bar on macOS) and keep Orin running. Use Quit Orin from the tray menu or Cmd+Q to exit. Off by default; applies only to this device.',
      ...
      loading: 'Loading Orin configuration...',
    ...
    hudModifier: {
      ...
      permission:
        'Allow Orin in System Settings → Privacy & Security → Input Monitoring, then retry. This gesture does not record keystrokes or capture your screen.',
      unavailable:
        'The HUD gesture helper could not start or stopped unexpectedly. Retry, or restart Orin. The existing HUD shortcut still works inside Orin.',
      missingHelper:
        'This Orin installation is missing the HUD gesture helper. Update or reinstall Orin, then retry.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current Orin draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets Orin detect both Command keys while another app is active. Allow Orin in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets Orin capture the frontmost app window when you use this shortcut. Allow Orin in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart Orin if macOS asks.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Orin.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Orin gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Orin Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Orin Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Orin runtime managed by this app.',
      kindRemoteDesc: 'A Orin gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Orin Cloud account.',
      kindSshDesc: 'A Orin install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Orin manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Orin Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc:
        'Connection settings can only be changed from the Orin Desktop app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a Orin backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way Orin was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart Orin without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Orin backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Orin backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Orin Cloud',
      cloudDesc: 'Sign in once to Orin Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Orin Cloud',
      cloudSignIn: 'Sign in to Orin Cloud',
      cloudSignedIn: 'Signed in to Orin Cloud',
      cloudNeedsSignIn: 'Sign in to Orin Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Orin Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Orin Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Orin Cloud',
      cloudSignedOutMessage: 'Cleared the Orin Cloud session.',
      ...
      probeError:
        "Orin can't reach that address. Check the URL and that the other computer is running Orin — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'Orin Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Orin ${version}` : ''}`,
      ...
      sshDesc:
        'Orin is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Orin path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Orin found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Orin runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrPlatform:
        'Unsupported remote platform. Orin Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Orin on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Orin. Review the exact configuration below — it comes from the link, not from Orin.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Orin starts and manages the server for you.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Orin runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Orin at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Orin can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Orin browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    plugins: {
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Orin to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Orin catalog${sha ? ` at pin ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D is not in the Orin plugin catalog. Nothing was installed.`,
      deepLinkCatalogUnavailable:
        'Could not load the Orin plugin catalog. Check your connection and open the link again.'
    },
  ...
  starmap: {
    ...
    emptyDesc: 'As Orin builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Orin to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Orin to generate pets.',
      backgroundHint: 'You can close this — Orin will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Orin desktop' },
    ...
    hermesActiveSessions: (version, count) => `Orin ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "Orin couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Orin installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Orin creates the bot and detects your Telegram user ID automatically.',
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Orin you point it at, instead of this computer.',
    ...
    defaultDescription: 'Used when Orin opens and for new chats. Existing sessions stay in their profiles.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Orin environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  modelAssignment: {
    saveFailed: 'Orin did not save that model change.',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Orin will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Orin backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Orin. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Orin backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Orin...',
    placeholderReconnecting: 'Reconnecting to Orin…',
    ...
    voiceEngineChained: 'Speech-to-text + Orin voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Orin)',
    ...
    attachUrlDesc: 'Orin will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Orin…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Orin…',
    ...
    unsupportedMessage: 'This version of Orin can’t update itself from inside the app.',
    connectionRetry:
      "Orin couldn't reach the update server. Check your internet connection and try again. If you use a remote Orin, make sure it is online.",
    gitUnusable: 'Orin could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
    ...
    manualBody: 'You installed Orin from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Orin will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Orin desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Orin updater takes over in its own window and reopens Orin automatically when it’s done. Please don’t reopen Orin yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Orin reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Orin reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Orin?',
    blockerBody:
      'Orin needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Orin',
    foreignBlockerBody:
      'Orin can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Orin can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Orin is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Orin whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm Orin. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Orin needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Orin Desktop',
    setupChoiceDesc:
      'Connect this app to a Orin gateway you already run, or install Orin locally on this computer.',
    connectExistingTitle: 'Connect to existing Orin',
    ...
    installLocalTitle: 'Install Orin locally',
    installLocalDesc: 'Download Orin, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Orin Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Orin',
    remoteSetupDesc: 'Enter your gateway URL. Orin Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Orin gateway, including https:// when remote.',
    ...
    settingUpTitle: 'Setting up Orin Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Orin is running, the internet connection dropped, or antivirus blocked the installer. Close other Orin windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
      'This is a one-time setup. The Orin installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Orin Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Orin is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Orin…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Orin',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Orin at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Orin connects automatically',
    ...
    authorizeThere: 'Authorize Orin there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Orin there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    retiredBody:
      "Your session ended before the sign-in finished. Orin will start a new one; then sign in again whenever you're ready.",
    errorBody: "Sign-in didn't finish. Try again whenever you're ready.",
    busyHeading: 'Almost there',
    busyBody: wait =>
      `Orin couldn't finish signing you in because the Nous service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "Orin couldn't reach the Nous service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This Orin is already signed in to a Nous account.',
    setupFailed: {
      gateClosed:
        "This version of Orin can't start without a Nous account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using Orin without signing in is paused for a moment. Orin will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so Orin will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "Orin couldn't reach the Nous service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      ...
      generic:
        "Orin couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Orin Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Orin Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Orin will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Orin is restarting...',
      askRestart: 'Ask Orin to restart the server',
      lookingRestart: taskId => `Orin is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Orin is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Orin to open a page.',
      finishedRestarting: message => `Orin finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Orin could not restart the server.',
      stillWorking:
        'Orin is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Orin is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'Orin hit a problem',
        generic: "Orin couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'Orin hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so Orin could not save this conversation. Free some space, then retry.',
        endpoint:
          "Orin can't reach your custom model server. Check that it is running, then send your message again.",
        gateway:
          'Orin hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while Orin was replying. Retry, or copy the details if it keeps happening.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Orin could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something Orin could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Orin got stuck in a loop',
          body: 'The reply kept repeating the same steps, so Orin stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another Orin window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so Orin could not save this conversation. Free some space, then retry.'
        },
        ...
        free_tier_disabled: {
          title: 'Using Orin without signing in is switched off right now',
        ...
        free_tier_model_not_free: {
          ...
          body: "Orin uses the free model for now. Sign in with a Nous account for more models, it's free."
        },
        free_tier_route: {
          title: "Orin couldn't reach the free model on this route",
        ...
        free_tier_refused: {
          title: "Orin couldn't send that without signing in",
      ...
      errorToastTitle: "Orin couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenHermesFolder: 'Open Orin folder',
      errorOpenHermesFolderFailed: 'Could not open the Orin folder',
    ...
    approval: {
      gatewayDisconnected:
        'Orin is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask Orin to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Orin won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'Orin is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'Orin needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Orin reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Orin types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Orin enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Orin Desktop to use Save Image.',
    restartToSaveImages: 'Restart Orin Desktop to save images',
    ...
    handoff: {
      ...
      timedOut:
        "Orin couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Orin loads when the work calls for them.'
      },
      messaging: {
        title: 'Orin away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Orin made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Orin — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
