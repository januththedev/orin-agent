...
// two in step.
const TRANSPARENT_WINDOWS = new Set(['hud', 'overlay', 'quick', 'wake', 'intro', 'glass'])
...
} else if (winParam === 'glass') {
  void import('./app/glass/glass-root').then(({ mountGlass }) => mountGlass())
