...
/**
 * Nous — the canonical Orin desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Orin's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Orin desktop identity: GitHub's chrome carrying Nous
