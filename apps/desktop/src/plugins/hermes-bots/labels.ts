...
export function displayName(bot: Partial<RosterRow>, meta?: BotMeta | null): string {
  ...
  // "Orin". Annotated active rows carry sourceScoped too, and keying this
  ...
  // never generic "Orin" or a hostname-derived label.
  if (alias) {
  ...
  // that reads like nobody bothered. Present it as Orin (the agent it is)
