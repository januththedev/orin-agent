...
const en: BotsMessages = {
  roster: {
    ...
    rosterUnavailable: reason =>
      `Roster unavailable: ${reason}. If your gateway predates profiles.list, update Orin and restart the gateway.`,
    waitingForGateway:
  ...
  bot: {
    ...
    openAnotherChatUnsupported: 'Update Orin Desktop to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update Orin Desktop to chat with bots on other connections.',
    openNeedsUpdateTitle: 'This bot lives on an older Orin',
    openNeedsUpdateMessage: connectionLabel => `Update ${connectionLabel}, then try again.`,
    openUnreachableTitle: 'Orin couldn’t reach the computer this bot runs on',
...
const ja: BotsMessages = {
  roster: {
    ...
    retryNow: '今すぐ再試行',
    rosterUnavailable: reason =>
      `名簿を取得できません: ${reason}。ゲートウェイが profiles.list より前の場合は、Orin を更新してゲートウェイを再起動してください。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '別のボットチャットを開くには Orin Desktop を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには Orin Desktop を更新してください。',
    openNeedsUpdateTitle: 'このボットは古い Orin 上で動いています',
    openNeedsUpdateMessage: connectionLabel => `${connectionLabel} を更新してから、もう一度お試しください。`,
    openUnreachableTitle: 'このボットが動いているコンピューターに Orin が接続できませんでした',
...
const zh: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重试',
    rosterUnavailable: reason => `无法获取名单：${reason}。如果网关早于 profiles.list，请更新 Orin 并重启网关。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '请更新 Orin Desktop 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 Orin Desktop 以与其他连接上的机器人聊天。',
    openNeedsUpdateTitle: '这个机器人运行在较旧的 Orin 上',
    openNeedsUpdateMessage: connectionLabel => `请更新 ${connectionLabel}，然后重试。`,
    openUnreachableTitle: 'Orin 无法连接到运行这个机器人的电脑',
...
const zhHant: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重試',
    rosterUnavailable: reason => `無法取得名單：${reason}。如果閘道早於 profiles.list，請更新 Orin 並重新啟動閘道。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '請更新 Orin Desktop 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 Orin Desktop 以與其他連線上的機器人聊天。',
    openNeedsUpdateTitle: '這個機器人運行在較舊的 Orin 上',
    openNeedsUpdateMessage: connectionLabel => `請更新 ${connectionLabel}，然後再試一次。`,
    openUnreachableTitle: 'Orin 無法連線到運行這個機器人的電腦',
