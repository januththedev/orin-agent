/**
 * Orin Bot Mode — a "one chat per agent" roster for the Orin desktop.
 *
 * Left pane "Bots": one row per Orin profile (a bot = an agent profile) with
 ...
 *
 * Right tile "Routines": scheduled tasks (Orin cron jobs) scoped to the
...
export default {
  ...
  register(ctx: PluginContext) {
    ...
    // A bot's chat before it has spoken: core's splash is Orin' wordmark and
