...
export const en: KanbanMessages = {
  ...
  notify: {
    ...
    gaveUpBody: 'Orin couldn’t finish this task. Open Kanban to see why and reassign it.',
    crashedTitle: 'Task hit a problem — Orin will retry it automatically',
    timedOutTitle: 'Task took too long — Orin will retry it automatically',
...
const ja: KanbanMessages = {
  ...
  notify: {
    ...
    gaveUpBody: 'Orin はこのタスクを完了できませんでした。かんばんを開いて原因を確認し、再割り当てしてください。',
    crashedTitle: 'タスクで問題が発生 — Orin が自動で再試行します',
    timedOutTitle: 'タスクに時間がかかりすぎました — Orin が自動で再試行します',
    openKanban: 'かんばんを開く',
...
const zh: KanbanMessages = {
  ...
  notify: {
    ...
    gaveUpTitle: '任务已停止',
    gaveUpBody: 'Orin 无法完成这个任务。打开看板查看原因并重新分配。',
    crashedTitle: '任务遇到问题 — Orin 将自动重试',
    timedOutTitle: '任务耗时过长 — Orin 将自动重试',
    openKanban: '打开看板',
...
const zhHant: KanbanMessages = {
  ...
  notify: {
    ...
    gaveUpTitle: '任務已停止',
    gaveUpBody: 'Orin 無法完成這個任務。開啟看板查看原因並重新指派。',
    crashedTitle: '任務遇到問題 — Orin 將自動重試',
    timedOutTitle: '任務耗時過長 — Orin 將自動重試',
    openKanban: '開啟看板',
