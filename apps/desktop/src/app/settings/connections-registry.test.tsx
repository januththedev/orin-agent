...
describe('ConnectionsRegistrySection', () => {
  ...
  it('saves a custom remote Orin path for SSH connections', async () => {
    render(<ConnectionsRegistrySection />)
  ...
  it('clears a saved remote Orin path back to auto-detect', async () => {
  ...
  it('offers every kind on create and disables Local while the managed entry exists', async () => {
    ...
    expect(screen.getByRole('button', { name: 'Orin Cloud' })).toBeTruthy()
