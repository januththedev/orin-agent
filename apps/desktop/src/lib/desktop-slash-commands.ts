...
/** Why a known Orin command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Orin profile', surface: action('profile') },
  {
    name: '/skin',
 ...
 * Orin' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Orin and were never asked for. It is
