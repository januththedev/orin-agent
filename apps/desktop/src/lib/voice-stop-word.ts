...
//
// When someone is in a hands-free "Hey Orin" voice chat, the natural way to
...
// phrase (optionally addressed to Orin), so a real turn that merely contains
 ...
 * to Orin). Returns false for anything that merely contains "stop" as part of
